<div class="uix-field-wrapper">
	<ul class="ui-tab-nav">
		...
		<?php if ( class_exists( 'LSX_Testimonials' ) ) { ?>
			...
			<li><a href="#ui-testimonials" class="<?php echo esc_attr( $class_active ) ?>"><?php esc_html_e( 'Testimonials', 'lsx-currencies' ); ?></a></li>
		<?php } ?>
		...
		<?php if ( class_exists( 'LSX_Projects' ) ) { ?>
			...
			<li><a href="#ui-projects" class="<?php echo esc_attr( $class_active ) ?>"><?php esc_html_e( 'Projects', 'lsx-currencies' ); ?></a></li>
		<?php } ?>
		...
		<?php if ( class_exists( 'LSX_Blog_Customizer' ) ) { ?>
			...
			<li><a href="#ui-blog-customizer" class="<?php echo esc_attr( $class_active ) ?>"><?php esc_html_e( 'Blog Customizer (posts widget)', 'lsx-currencies' ); ?></a></li>
		<?php } ?>
		...
		<?php if ( class_exists( 'LSX_Sharing' ) ) { ?>
			...
			<li><a href="#ui-sharing" class="<?php echo esc_attr( $class_active ) ?>"><?php esc_html_e( 'Sharing', 'lsx-currencies' ); ?></a></li>
		<?php } ?>
		...
		<?php if ( class_exists( 'LSX_Videos' ) ) { ?>
			...
			<li><a href="#ui-videos" class="<?php echo esc_attr( $class_active ) ?>"><?php esc_html_e( 'Videos', 'lsx-currencies' ); ?></a></li>
		<?php } ?>
		...
		<?php if ( class_exists( 'LSX_Search' ) ) { ?>
			...
			<li><a href="#ui-search" class="<?php echo esc_attr( $class_active ) ?>"><?php esc_html_e( 'Search', 'lsx-currencies' ); ?></a></li>
		<?php } ?>
	</ul>
